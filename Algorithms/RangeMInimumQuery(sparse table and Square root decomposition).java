public class RangeMinimumQuery {
    ...
    static int[] blk; // block array
    static int blkSize; // size of each block
    static int[][] table; // sparse table

    public static void preprocessSqrt(int[] nums, int n) {
        blkSize = (int) Math.sqrt(n);
        blk = new int[(n + blkSize - 1) / blkSize]; // ceil(n / blkSize)
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Min in range (1, 4): " + querySqrt(nums, 1, 4)); // Output: 1
        System.out.println("Min in range (2, 6): " + querySqrt(nums, 2, 6)); // Output: 1
        System.out.println("Min in range (5, 9): " + querySqrt(nums, 5, 9)); // Output: 2
        System.out.println("Min in range (0, 10): " + querySqrt(nums, 0, 10)); // Invalid range

        preprocessSparse(nums, n);
        System.out.println("Sparse Table:");
        System.out.println("Min in range (1, 4): " + querySparse(1, 4)); // Output: 1
        System.out.println("Min in range (2, 6): " + querySparse(2, 6)); // Output: 1
        System.out.println("Min in range (5, 9): " + querySparse(5, 9)); // Output: 2
        System.out.println("Min in range (0, 10): " + querySparse(0, 10)); // Invalid range
    }
}
